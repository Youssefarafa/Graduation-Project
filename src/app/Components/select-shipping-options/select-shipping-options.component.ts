  ...
  shippingOptions = [
    {
      ...
      Description: {
        ...
        Details:
          'Includes priority handling and real-time tracking. Ideal for urgent deliveries or high-value items.',
      },
    ...
    },
    {
      ...
      Description: {
        ...
        Details:
          'Reliable standard shipping with tracking. Suitable for most personal and business deliveries.',
      },
    ...
    },
    {
      ...
      Description: {
        ...
        Details:
          'Economy service for budget-conscious deliveries. Basic tracking included. Use for non-urgent items.',
      },
    ...
    },
    {
      ...
      Description: {
        ...
        Details:
          'Longest delivery time with no guaranteed date. No tracking. Suitable only for non-critical shipments.',
      },
  ...
  onSubmit() {
    ...
    if (this.shippingForm.valid) {
      ...
      localStorage.setItem(
        'shippingForm',
        JSON.stringify(this.shippingForm.value)
      );
